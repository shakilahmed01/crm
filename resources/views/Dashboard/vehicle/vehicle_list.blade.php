                        ...
                        <tr>
                            ...
                            <td>
                                @if ($list->activation == 'Active')
                                    <a href="{{url('vehicle/activation')}}/{{$list->id}}/{{$list->activation}}" class="btn btn-success">Active</a>
                                @else
                                    <a href="{{url('vehicle/activation')}}/{{$list->id}}/{{$list->activation}}" class="btn btn-danger">Dective</a>
                                @endif
                            </td>
                            ...
                            <td>
                              <a href="{{ url('/v1/dashboard/vehicle/list') }}/{{ $list->id }}/{{ $list->slug }}" class=" btn-sm btn-primary">Edit</a>
